...
// Special Elite fallback (not the generic 'cursive' keyword) so if Caveat is
// slow/fails to load, the flavor text still reads as rough/typewritten
// rather than silently degrading to a plain system italic serif.
export const fontHand = "'Caveat','Special Elite',cursive";

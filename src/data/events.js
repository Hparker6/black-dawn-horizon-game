  ...
  { title:'The Nursery Window',
    ...
    choices:[
      { text:'Leave what food you can spare',
        result:{days:1,health:-1,msg:'You leave half your rations on the sill and walk away without knocking. You never find out if it mattered.',tag:'GAVE WHAT YOU HAD'} },
      { text:'Knock and offer to help', check:{stat:'wits',needed:6,label:'WITS'},
        success:{days:3,msg:'A woman opens the door an inch, takes what you offer, and shuts it again. It\'s enough.'},
        fail:{days:2,health:-2,msg:"Whoever's inside doesn't trust strangers at the door. You leave the way you came, faster."} },
      { text:"Keep walking. You can't save everyone.",
        result:{days:1,msg:'The sign stays in the window behind you.',tag:'KEPT WALKING'} },
    ]},
  { title:'The Toll Bridge',
    ...
    choices:[
      { text:"Pay what they're asking",
        result:{days:1,health:-1,msg:'You hand over a share of your supplies. They lift the chain without a word.',tag:'PAID TOLL'} },
      { text:'Push through the chain point', check:{stat:'combat',needed:8,label:'COMBAT'},
        success:{days:1,msg:"You put one down before the other two decide the toll isn't worth dying for."},
        fail:{days:2,health:-3,msg:"Three against one is worse math than you thought. You pay double to walk away."} },
  ...
  { title:'The Rival Scavenger',
    ...
    choices:[
      { text:'Split the haul evenly',
        result:{days:1,msg:'You divide what\'s left down the middle and go your separate ways. Nobody draws a weapon.',tag:'SPLIT EVEN'} },
      { text:'Push them off the site', check:{stat:'combat',needed:7,label:'COMBAT'},
        success:{days:1,health:-1,msg:'You make it clear this find is yours. They leave cursing, but they leave.'},
